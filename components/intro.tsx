...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id='home'
      className='mb-28 sm:mt-2 max-w-[50rem] text-center sm:mb-0 scroll-mt-[99rem]'
    >
      ...
      >
        <span className='font-bold'>Dmytro is a front-end developer</span> who
        specializes in building user interfaces, ensuring responsive design, and
        optimizing web performance to create seamless user experiences.
      </motion.h1>
